...
const Home = (props) => (
  <Container>
    ...
    <RightSection>
      <ContentContainer>
        <Content>
          YouTube recommendations failing you?<br/>Subscriptions getting stale?<br/>Discover your next favorite creator from our hand-picked recommendations sent to your inbox every other Friday.
        </Content>
      </ContentContainer>
      <Mailchimp />
    </RightSection>
